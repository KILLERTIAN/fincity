...
export default function StockDetailScreen() {
    ...
    const handleBuy = () => {
        ...
        updatePlayerMoney(-totalCost, 'spend', `Bought ${qty} ${stock.symbol}`);
    ...
    const handleSell = () => {
        ...
        if (qty > holdings) {
            Alert.alert('Insufficient Holdings', 'You don\'t have enough shares to sell.');
            return;
        }

        const totalValue = qty * stock.price;
        Haptics.notificationAsync(Haptics.NotificationFeedbackType.Success);
        updatePlayerMoney(totalValue, 'earn', `Sold ${qty} ${stock.symbol}`);
        setHoldings(prev => prev - qty);
                        ...
                        <Animated.View entering={FadeInDown.delay(250)}>
                            ...
                            >
                                ...
                                <View style={styles.holdingsRight}>
                                    <Text style={styles.holdingsTotal}>₹{(holdings * stock.price).toFixed(2)}</Text>
                                    <Text style={styles.holdingsGain}>
                                        {isPositive ? '+' : ''}{(holdings * stock.changeAmount).toFixed(2)} today
                                    </Text>
                                </View>
                            </LinearGradient>
                        </Animated.View>
                    ...
                    <View style={styles.modalContent}>
                        ...
                        <View style={styles.stockInfo}>
                            ...
                            <View>
                                ...
                                <Text style={styles.stockPrice}>₹{stock.price.toFixed(2)} per share</Text>
                            </View>
                        </View>
                        ...
                        <View style={styles.totalRow}>
                            ...
                            <Text style={styles.totalValue}>₹{((parseInt(quantity) || 0) * stock.price).toFixed(2)}</Text>
                        </View>
